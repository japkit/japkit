...
class FromTemplateGenerator extends MemberGeneratorSupport implements MemberGenerator {
	...
	override createMembers(TypeElement templateClass, TypeElement annotatedClass, GenTypeElement generatedClass, AnnotationMirror annotation,
		AnnotationMirror templateAnnotation, AnnotationMirror genClassMetaAnnotation) {

		printDiagnosticMessage['''Process Java template «templateClass»''']

		createTemplateRule(templateClass, templateAnnotation).apply(annotatedClass, generatedClass, annotation)
	}
