...
public class AnnotationAndParent implements AnnotationWrapper {
  ...
  private List<Path.Segment> getPathFromRootAnnotation_() {
    ...
    if ((this.parentAnnotation == null)) {
      _xifexpression = CollectionLiterals.<Path.Segment>newArrayList();
    } else {
  ...
  public AnnotationAndParent(final AnnotationMirror annotation, final Path.Segment pathSegment, final AnnotationAndParent parentAnnotation, final Element annotatedElement) {
    super();
