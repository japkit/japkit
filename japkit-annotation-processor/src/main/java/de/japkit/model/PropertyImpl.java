...
public class PropertyImpl implements Property {
	...
	public PropertyImpl(final TypeMirror type, final String name, final ExecutableElement getter, final ExecutableElement setter,
	...
	public <A extends Annotation> A[] getAnnotationsByType(Class<A> annotationType) {
		return this.fieldOrGetter().getAnnotationsByType(annotationType);
	}

	@Override
	public <A extends Annotation> A getAnnotation(final Class<A> annotationType) {
		return this.fieldOrGetter().getAnnotation(annotationType);
	}
