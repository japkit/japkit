...
public @interface InnerClass {
	...
	/**
	 * By default, only one inner class is generated by that annotation. To generate
	 * multiple similar inner classes you can set an EL expression here. It must be an
	 * {@link Iterable} over {@link Element}. For each of those elements, an inner class
	 * is generated. The element is also used as rule source element for
