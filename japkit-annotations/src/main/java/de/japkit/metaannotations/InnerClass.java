...
public @interface InnerClass {
	...
	/**
	 * @return the kind of type element to generate. Allowed values: CLASS,
	 *         INTERFACE, ENUM
	 */
	...
	/**
	 * By default, the abstract modifier on a class template is always removed
	 * when generating a class. The rationale behind this is to allow abstract
	 * method templates (to avoid writing dummy method bodies). This behavior
	 * can be switched off by setting this annotation value to true.
	 * 
	...
	/**
	 * If true, the modifiers from the current src element a copied and merged
	 * with the ones given by modifiers AV.
	 * 
	 * @return
	 */
	...
	/**
	 * @return the templates to be called to contribute members to the generated
	 *         class
	 */
	 ...
	 *         class. Note: Compilation errors may appear in eclipse, when that
	 *         is set to true.
	 */
	boolean behaviorInternalInterfaceIsInnerClass() default false;

	/**
	 * @return the name of the implementation class for the internal interface.
	 *         This is always an inner class of the generated class.
	 */
	String behaviorInternalInterfaceImpl() default "InternalImpl";

	/**
	 * If the user declares a method in the behavior class that already exists
	 * in the generated class, than the generated method is renamed. This allows
	 * the used declared method to call the generated method and so kind of
	 * "wrapping" it.
	 * <p>
