...
public abstract class ControllerMembers {
	...
	@Method(iterator = "#{datetimeProperties}", nameExpr = "getDateTimeFormat#{element.name.toFirstUpper}", vars = @Var(
			name = "dtfAnnotation", expr = "#{element}", annotation = DateTimeFormat.class),
