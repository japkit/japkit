...
class Util {
			...
			for (int i = 0; i < mParamCount; i++) {
				...
				if (w.isVarArgs() && i == (mParamCount - 1)) {
					if (i == paramCount || (paramValues != null && paramValues.length == i)) {
						...
						// Use MAX_VALUE so this matches only if nothing else
						// does
	...
	private static class MatchResult implements Comparable<MatchResult> {
		...
		public boolean equals(Object o) {
			return o == this
					|| (null != o && this.getClass().equals(o.getClass()) && ((MatchResult) o).getExactCount() == this.getExactCount()
							...
							&& ((MatchResult) o).isVarArgs() == this.isVarArgs() && ((MatchResult) o).isBridge() == this.isBridge());
		}
